 ...
 * @author jayatipatel
 */
public class DeliverymanModify extends javax.swing.JPanel {

    /**
     * Creates new form DeliverymanModify
     */
    EcoSystem es;
    public DeliverymanModify(EcoSystem es) {
        initComponents();
        this.es=es;
    }
    ...
    private void SearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchActionPerformed
        ...
        DeliveryMan r = es.getDeliveryManDirectory().searchDeliveryMan(username);
        if(r==null){
