 ...
 * @author jayatipatel
 */
public class RestaurantCreate extends javax.swing.JPanel {

    /**
     * Creates new form RestaurantCreate
     */
    EcoSystem es;
    public RestaurantCreate(EcoSystem es) {
        initComponents();
        this.es=es;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Creating Restaurant Admin");
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel2, jLabel4, jLabel5, jTextField1, jTextField3, jTextField4});
    ...
    private void createActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createActionPerformed
        ...
        if(es.getUserAccountDirectory().checkIfUsernameIsUnique(username)){
            ...
            UserAccount ua = es.getUserAccountDirectory().createUserAccount(username, password, Role.RoleType.RestaurantAdmin);
