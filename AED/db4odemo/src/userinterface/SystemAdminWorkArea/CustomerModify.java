 ...
 * @author jayatipatel
 */
public class CustomerModify extends javax.swing.JPanel {

    /**
     * Creates new form CustomerModify
     */
    EcoSystem es;
    public CustomerModify(EcoSystem es) {
        initComponents();
        this.es=es;
    }
    ...
    private void EditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditActionPerformed
        ...
        Customer c = es.getCustomerDirectory().searchCusotmer(username);
        c.setName(name);
    ...
    private void SearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchActionPerformed
        ...
        if(c==null){
            ...
            jTextField3.setText(c.getPassword());
        }
